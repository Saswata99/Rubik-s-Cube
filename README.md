# Rubik's Cube Solver 
Dsigning a 3X3 rubik's cube solver using opencv-python.
Using kociemba two-phase algorithm to find optimal solution(for any case maximum number of face turns is 20).
